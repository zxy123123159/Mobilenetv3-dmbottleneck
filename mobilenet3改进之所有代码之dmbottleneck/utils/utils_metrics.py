...
def get_classes(classes_path):
    ...
    return class_names
classes_path = 'E:\classification-keras-main\model_data\cls_classes.txt'
class_names = get_classes(classes_path)

def evaluteTop1_5(classfication, lines, metrics_out_path):
    label = [label for label in class_names]
    confusion = ConfusionMatrix(num_classes=len(class_names), labels=label)
    correct_1 = 0
    correct_5 = 0
    preds   = []
    labels  = []
